      ...
      <div className="w-full px-7 flex flex-col items-start mt-4">
        ...
        <div className="relative w-full h-[120px] mt-6 justify-center font-medium">
          ...
          <img
            src={addProfile}
            alt="Add Profile"
            className="w-[120px] h-[120px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 cursor-pointer"
          />
        </div>
        ...
        <div className="w-full mt-9">
          ...
          <input
            ...
            className="w-full border-b border-(--fill-color3) mt-2 p-2 focus:outline-none"
          />
        </div>
        ...
        <div className="w-full mt-9">
          ...
          <input
            ...
            placeholder=""
            className="w-full h-[50px] rounded-[10px] border border-(--fill-color3) mt-2 p-2 focus:outline-none"
          />
        </div>

...
//   couponId: number;
//   couponName: string;
//   expiredDate: string; // ISO 8601 string (e.g., "2025-11-26T07:24:21.166Z")
//   used: boolean;
// }

// // API 주소 (환경 변수나 상수로 관리하는 곳에서 가져와야 합니다)
...
//       try {
//         // 실제 토큰이 필요하다면 headers에 Authorization 추가 필요
...
//         // 사용하지 않은 쿠폰만 보여줄지, 모두 보여줄지에 따라 필터링 가능
//         // 여기서는 API 응답 그대로를 저장합니다.
//         setCoupons(data);
//       } catch (error) {

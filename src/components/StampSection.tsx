...
// const SWIPE_THRESHOLD = 60; // 스와이프 민감도

// /**
//  * [수정] 스탬프 카드의 '내용물' (작아진 크기에 맞게 조정)
//  */
...
//               opacity = offset <= 3 ? 1 - 0.25 * offset : 0;
//               zIndex = 10 - offset;
//             } else {
//               // (Past Cards - "위에" 있는 카드)
//               const progress = Math.min(
...
//               opacity = currentOffset <= 3 ? 1 - 0.25 * currentOffset : 0;
        ...
        >
          {stampCardsData.map((card, index) => {
            ...
            return (
              ...
              >
                {/* [수정] 활성 카드(offset === 0)일 때만 내용물 렌더링 */}
                {offset === 0 ? (
                  <StampCardContent
                    currentStamps={card.currentStamps}
                    totalStamps={card.totalStamps}

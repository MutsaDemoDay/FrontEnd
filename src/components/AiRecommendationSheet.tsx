...
//         user_id: 4,
//         location: {
//           latitude: 37.55246607831308, // 필요하다면 props로 받아온 실제 위치 사용
...
const MOCK_DATA = [
  ...
  },
  {
    storeId: 6,
    storeName: '열공커피 카페',
    storeAddress: '서울특별시 마포구 마포대로 173-14',
  },
  {
    storeId: 7,
    storeName: '태양커피',
    storeAddress: '서울특별시 마포구 잔다리로7길 18',
  },
  {
    storeId: 8,
    storeName: '태양커피 2호점',
    storeAddress: '서울특별시 성동구 왕십리로10길 18',
  },
  {
    storeId: 9,
    storeName: '태양커피 4호점',
    storeAddress: '서울특별시 마포구 와우산로11길 9',
  },
];
